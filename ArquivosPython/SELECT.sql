...
SELECT * 
FROM #DFTOTALVISUALIZACAO
WHERE NomCanal = 'Quintellão na Área'
...
WHERE NumVisualizacao < 1000000000 

UPDATE A
SET Classificacao = 
CASE WHEN NumVisualizacao < 1100000000 THEN 'X1'
WHEN NumVisualizacao > 1100000000 AND NumVisualizacao < 1300000000 THEN 'X2'
